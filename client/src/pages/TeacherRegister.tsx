...
const TeacherRegister = () => {
  ...
  useEffect(() => {
    ...
    const fetchAssignedSections = async () => {
      try {
        const response = await fetch('/api/teachers/public/assigned-sections');
        if (response.ok) {
          const data = await response.json();
          setAssignedSections(data.data.sections || []);
        }
      } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            ...
            >
              ...
              {formData.grade && getSectionsForGrade(formData.grade).map((section) => {
