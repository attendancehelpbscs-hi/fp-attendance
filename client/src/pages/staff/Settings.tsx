...
const Settings: FC = () => {
  ...
  const handleCropComplete = (croppedImageData: string) => {
    ...
    setProfilePictureBase64(croppedImageData.split(',')[1]);
    setCameraImage('');
    onCropClose();
    toast.success('Photo captured and cropped successfully!');
  };
                ...
                <VStack spacing={4} align="stretch">
                  ...
                  <FormControl>
                    ...
                    <VStack spacing={3}>
                      ...
                      {(selectedFile || cameraImage) && (
                        <Text fontSize="sm" color="gray.600">
                          {selectedFile ? `Selected: ${selectedFile.name}` : 'Photo captured from camera'}
                        </Text>
                      )}
                    </VStack>
                  </FormControl>
