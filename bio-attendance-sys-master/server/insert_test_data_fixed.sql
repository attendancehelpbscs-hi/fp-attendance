...
('test-1', (SELECT id FROM Student WHERE matric_no = '88888'), 'test-attendance-1', 'IN', 'CS101', 'present', '2024-01-15 08:30:00'),
('test-2', (SELECT id FROM Student WHERE matric_no = '88888'), 'test-attendance-2', 'IN', 'CS101', 'present', '2024-01-16 08:45:00'),
('test-3', (SELECT id FROM Student WHERE matric_no = '88888'), 'test-attendance-3', 'IN', 'CS101', 'present', '2024-01-17 09:00:00');
